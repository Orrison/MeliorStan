...
class AllowConsecutiveUppercaseTest extends RuleTestCase
{
    public function testExampleClass(): void
    {
        $this->analyse([
            ...
            [sprintf(CamelCaseParameterNameRule::ERROR_MESSAGE_TEMPLATE, '_isHttpResponse'), 10],
            ...
            [sprintf(CamelCaseParameterNameRule::ERROR_MESSAGE_TEMPLATE, '_isHttpResponse'), 23],
            ...
            [sprintf(CamelCaseParameterNameRule::ERROR_MESSAGE_TEMPLATE, '_isHttpResponse'), 38],
            ...
            [sprintf(CamelCaseParameterNameRule::ERROR_MESSAGE_TEMPLATE, '_isHttpResponse'), 51],
            ...
            [sprintf(CamelCaseParameterNameRule::ERROR_MESSAGE_TEMPLATE, '_isHttpResponse'), 64],
